...
public final class RustlingSpotsFabricConfigScreen extends Screen {
    ...
    public RustlingSpotsFabricConfigScreen(Screen parent) {
    ...
    private void saveAndClose() {
        try {
            ...
            RustlingSpotsFabricClient.syncRewardMessagePreference();
